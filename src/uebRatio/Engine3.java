...
public class Engine3 {
	...
	/**
	 * losgehts  
	 * Initial method for running the Engine3     
	 * This method can be run as often as desired and is used to calculate
	 * rational numbers. These are stored in a memory (ArrayList) in two arrays. 
	 */
	...
	/**
	 * saveRatioNumber     
	 * * @param r (ratio): Rational number to save.
	...
	/**
	 * saveOperator     
	 * @param op (String): Operator to save.
	 * Stores a rational number r in the form of a string in the ratioList array.    
	 */
	...
	/**
	 * restore     
	 * @param index (int): position of string in array
	 * @return restore (String): rational number     
	 * * Restore rational number as string from the array.    
	 */
	...
	/**
	 * restoreOperator     
	 * @param index (int): position of operator in array
	 * @return restoreOperator (String): oparator symbols
	 * Restore operator ( + - / *) as string from the array.    
	 */
	...
	/**
	 * string2ratio     
	 * @param str (String): rational number in string form
	 * @return ratioZahl (Ratio): converted rational number     
	 * converts string numbers to rational numbers form "number1/number2"    
	 */
	...
	/**
	 * showResults     
	 * show in the right order all stored in a memory (ArrayList) numbers and operators.    
	 */
	 ...
	 * @return angabe1 (Ratio): first declared rational number 
	 * read users declaration of the first rational number and prevent input errors.    
	 */
	 ...
	 * 
	 * @return angabe1 (Ratio): second declared rational number     
	 * read users declaration of the first rational number and prevent input errors.    
	 */
	 ...
	 * operatorDeclaration
	 * 
	 * @return operator (String): declared operator     
	 * read users declaration of the operator and prevent input errors.    
	 */
	 ...
	 * calculate
	 * 
	 * @param number1 (Ratio): declared first number
	 * @param number2 (Ratio): declared second number
	 * @param operator (String): declared operator
	 * @return result (Ratio): result rational number 
	 * Use defined in Ratio class mathematics algorithms to calculate rational numbers. 
	 * Operation on numbers depend on input operator    
	 */
	 ...
	 * continueQuestion
	 * 
	 * @return contin (boolean): yes or not answer     
	 * ask user to continue or to finish calculations. Catch input errors.    
	 */
